...
MODEL_PATH="../saves/Llama3.2-3B-Instruct/sft-se"
SEED=50
OUTPUT_DIR="datasets/Llama3.2-3B-Instruct"
DECODED_FILE="${OUTPUT_DIR}/output_${SEED}.json"
FINAL_DPO_FILE="../data/ultrafeedback_llama3.2_3B_dpo_se.json"
SFT_CONFIG="examples/train_full/llama3.2_3B_full_sft_se_ds3.yaml"
DPO_CONFIG="examples/train_full/llama3.2_3B_full_dpo_se_ds3.yaml"
NUM_GPUS=4
