...
PROMPT_FILE="../data/ultrafeedback_llama3.2_3B_sft_se.json"
MODEL_PATH="../saves/Llama3-8B-Instruct/sft-3B-8B"
SEED=50
OUTPUT_DIR="datasets/Llama3-8B-Instruct"
DECODED_FILE="${OUTPUT_DIR}/output_${SEED}.json"
FINAL_DPO_FILE="../data/ultrafeedback_llama3_3B_8B_dpo.json"
SFT_CONFIG="examples/train_full/llama3_8B_full_sft_3B_8B_ds3.yaml"
DPO_CONFIG="examples/train_full/llama3_8B_full_dpo_3B_8B_ds3.yaml"
NUM_GPUS=4
