...
MODEL_PATH="../saves/Qwen2.5-3B-Instruct/sft-se"
SEED=50
OUTPUT_DIR="datasets/Qwen2.5-3B-Instruct"
DECODED_FILE="${OUTPUT_DIR}/output_${SEED}.json"
FINAL_DPO_FILE="../data/ultrafeedback_qwen2.5_3B_dpo_se.json"
SFT_CONFIG="examples/train_full/qwen2.5_3B_full_sft_se_ds3.yaml"
DPO_CONFIG="examples/train_full/qwen2.5_3B_full_dpo_se_ds3.yaml"
NUM_GPUS=4
